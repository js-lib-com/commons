...
final class BooleansConverter implements Converter
{
  ...
  /**
   * Create a boolean value from given string. Returns boolean true only if string is one of next constants:
   * <em>true</em>, <em>yes</em>, <em>1</em>, <em>on</em>; otherwise returns false. Note that comparison is not case
   * sensitive.
   */
  @Override
