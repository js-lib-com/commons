...
/**
 * Invocation parameters (in)sanity tests. This utility class supplies convenient methods for invocation parameters validation,
 * see sample usage. All throws {@link IllegalArgumentException} if validation fails. Also all have a <code>name</code>
 * parameter used to format exception message; it is injected at message beginning exactly as supplied.
 * <p>
 * In sample code throws illegal argument exception if <code>file</code> argument is null. Exception message is 'File parameter
 * is null.'
 * 
 * <pre>
...
public class Params {
	...
	/**
	 * Check if file parameter is an existing directory. This validator throws illegal argument if given file does not exist or
	 * is not a directory.
	 * 
	 * @param parameter invocation file parameter,
	 * @param name parameter name.
	 * @throws IllegalArgumentException if <code>parameter</code> file is null or does not designate an existing directory.
	 */
	...
	/**
	 * Check if file parameter belongs to requested directory. This predicate test if given <code>directory</code> is ancestor
	 * of <code>parameter</code> file.
	 * 
	...
	public static void EQ(char parameter, char expected, String name) throws IllegalArgumentException {
		if (parameter != expected) {
			throw new IllegalArgumentException(String.format("%s is not %c.", name, expected));
		}
	}
	...
	public static void GTE(char parameter, char value, String name) throws IllegalArgumentException {
		if (parameter < value) {
			throw new IllegalArgumentException(String.format("%s is not greater than or equal %c.", name, value));
		}
	}
	...
	public static void LTE(char parameter, char value, String name) throws IllegalArgumentException {
		if (parameter > value) {
			throw new IllegalArgumentException(String.format("%s is not less than or equal %c.", name, value));
		}
	}
