...
public class ClassesUnitTest
{
  ...
  public void javaComplianceResourceName()
  {
    ...
    assertNotNull(ClassesUnitTest.class.getResourceAsStream("/com/jslib/util/ClassesUnitTest.class"));
    ...
    assertNull(ClassesUnitTest.class.getResourceAsStream("com/jslib/util/ClassesUnitTest.class"));
    ...
    assertNotNull(ClassesUnitTest.class.getClassLoader().getResourceAsStream("com/jslib/util/ClassesUnitTest.class"));
    assertNull(ClassesUnitTest.class.getClassLoader().getResourceAsStream("ClassesUnitTest.class"));
    assertNull(ClassesUnitTest.class.getClassLoader().getResourceAsStream("/com/jslib/util/ClassesUnitTest.class"));
  }

  @Test
  public void getResource() throws IOException
  {
    assertNotNull(Classes.getResource("com/jslib/util/ClassesUnitTest.class"));
    // not documented feature: accept but ignore leading path separator
    assertNotNull(Classes.getResource("/com/jslib/util/ClassesUnitTest.class"));

    URL url = Classes.getResource("com/jslib/util/resource.txt");
    assertNotNull(url);
  ...
  {
    URL url = Classes.getResource("com/jslib/util/");
    assertNotNull(url);
    assertEquals("file", url.getProtocol());
    assertTrue(url.getPath().endsWith("com/jslib/util/"));
  ...
  {
    assertNotNull(Classes.getResourceAsStream("com/jslib/util/ClassesUnitTest.class"));
    // not documented feature: accept but ignore leading path separator
    assertNotNull(Classes.getResourceAsStream("/com/jslib/util/ClassesUnitTest.class"));

    InputStream stream = Classes.getResourceAsStream("com/jslib/util/resource.txt");
  ...
  {
    assertNotNull(Classes.getResourceAsReader("com/jslib/util/ClassesUnitTest.class"));
    // not documented feature: accept but ignore leading path separator
    assertNotNull(Classes.getResourceAsReader("/com/jslib/util/ClassesUnitTest.class"));

    Reader reader = Classes.getResourceAsReader("/com/jslib/util/resource.txt");
  ...
  {
    assertNotNull(Classes.getResourceAsString("com/jslib/util/ClassesUnitTest.class"));
    // not documented feature: accept but ignore leading path separator
    assertNotNull(Classes.getResourceAsString("/com/jslib/util/ClassesUnitTest.class"));

    String expected = "resource.txt";
    String concrete = Classes.getResourceAsString("/com/jslib/util/resource.txt");
  ...
  {
    Class<?> innerClass = Classes.forName("com.jslib.util.ClassesUnitTest$InnerClass");
  ...
  {
    Object arg = Classes.newInstance("com.jslib.util.ClassesUnitTest$InnerClass");
    Object obj = Classes.newInstance("com.jslib.util.ClassesUnitTest$InnerClass", arg);
    assertNotNull(obj);
  ...
  {
    Object obj = Classes.newInstance("com.jslib.util.ClassesUnitTest$InnerClass", (Object)null);
    assertNotNull(obj);
    assertTrue(obj instanceof InnerClass);
  }
  ...
  {
    Object innerInterface = Classes.newInstance("com.jslib.util.ClassesUnitTest$InnerClass");
    Classes.newInstance("com.jslib.util.ClassesUnitTests$InnerClass", innerInterface, 123);
  }
  ...
  {
    Collection<String> resources = Classes.listPackageResources("com.jslib.util", "*.class");
    assertTrue(resources.size() > 0);
    assertTrue(resources.contains("com/jslib/util/Base64UnitTest.class"));
    assertTrue(resources.contains("com/jslib/util/ClassesUnitTest.class"));
    assertTrue(resources.contains("com/jslib/util/ClassesUnitTest$InnerClass.class"));
  }
